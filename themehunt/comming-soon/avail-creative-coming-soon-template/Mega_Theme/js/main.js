...
$('.clock-countdown').downCount({
    ...
    $('.clock-container').append("<div class='clock-zero'><h1 class='zeroday-txt'>"+$('.clock-countdown').attr('data-zeroday-text')+"</div></h1>");
}); 

$('.clock-container').append("<section class='c-block'><div class='hex hourmin-hex hour'><div class='hex-content'><p class='number hours'>00</p><div class='metric right'>hrs</div></div><div class='hex-corner-1'></div><div class='hex-corner-2'></div></div></section><section class='c-block'><div class='hex hourmin-hex min'><div class='hex-content'><div class='number minutes'>00</div><div class='metric left'>min</div></div><div class='hex-corner-1'></div><div class='hex-corner-2'></div></div></section><section class='c-block'><div class='hex sec-hex sec'><div class='hex-content'><div class='number seconds'>00</div><div class='metric top'>secs</div></div><div class='hex-corner-1'></div><div class='hex-corner-2'></div></div></section><section class='c-block'><div class='hex day-hex day'><div class='hex-content'><div class='number days'>00</div><div class='metric'>days</div></div><p class='c-text'>days left</p><div class='hex-corner-1'></div><div class='hex-corner-2'></div></div></section>");

if($('.site-config').attr('data-hrs-text') && ($('.site-config').attr('data-hrs-text') != '')){
    $('.clock-countdown .hour .metric').text($('.site-config').attr('data-hrs-text'));
}
if($('.site-config').attr('data-min-text') && ($('.site-config').attr('data-min-text') != '')){
    $('.clock-countdown .min .metric').text($('.site-config').attr('data-min-text'));
}
if($('.site-config').attr('data-sec-text') && ($('.site-config').attr('data-sec-text') != '')){
    $('.clock-countdown .sec .metric').text($('.site-config').attr('data-sec-text'));
}
if($('.site-config').attr('data-day-text') && ($('.site-config').attr('data-day-text') != '')){
    $('.clock-countdown .day .metric').text($('.site-config').attr('data-day-text'));
}
if($('.site-config').attr('data-daysleft-text') && ($('.site-config').attr('data-daysleft-text') != '')){
    $('.clock-countdown .day .c-text').text($('.site-config').attr('data-daysleft-text'));
}
